  ...
  return (
    <nav className="fixed z-50 w-screen flex bg-custom-cream justify-center md:justify-start items-center py-4 md:h-auto md:gap-4 md:pl-10 shadow-custom-dark-blue">
      ...
      <div className="flex items-center md:justify-center md:flex-none pr-5">
        ...
        <h1 className="text-custom-dark-blue font-montserrat font-semibold text-2xl md:text-center">
          Way Finder Edu
        </h1>
      </div>

      {user.email ? (
        <div className="hidden md:flex flex-1 items-center justify-end gap-3 md:mr-10 md:w-full md:flex-wrap md:gap-20 md:flex-row font-montserrat font-semibold text-custom-black">
          <Link to="/">
      ...
      {isMenuOpen && (
        <div className="fixed top-0 left-0 h-full w-1/2 bg-custom-cream z-50 flex flex-col items-end py-8 pl-7 pr-5 gap-4 shadow-lg">
          <img src="/burger-menu.svg" alt="menu" onClick={burgerClicked} className="pb-3"/>
          <Link
            to="/account"
            onClick={burgerClicked}
            className="text-end font-montserrat font-semibold text-custom-black hover:underline"
          >
            Hello, {user.name}
          </Link>
          <Link
            to="/"
            onClick={burgerClicked}
            className="font-montserrat font-semibold text-custom-black hover:underline"
          >
            Home
          </Link>
          <Link
