function Footer() {
    return (
        <div className="flex items-center justify-center h-12 bg-customLightBlue text-white">
            Way Finder Edu 2024
        </div>
    )
}
...
function Footer() {
    return (
        <div className="flex items-center justify-center h-auto bg-customDarkBlue text-customCream">
