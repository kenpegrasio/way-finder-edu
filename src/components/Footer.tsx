function Footer() {
    return (
        <div className="flex items-center justify-center h-auto bg-customDarkBlue text-customCream px-6 py-8 lg:px-24 lg:py-12">
            <div className="flex flex-col items-center px-4 md:px-0">
                <div className="flex grid-cols-2 items-center justify-center gap-2 lg:-ml-2">
                    ...
                    />
                    <p className="font-montserrat font-semibold text-customCream text-2xl lg:text-4xl md:text-3xl pt-2 lg:pt-4">
                        Way Finder Edu
                    </p>
                </div>
                <p className="font-montserrat font-medium text-customCream md:text-xl text-center text-md lg:text-2xl lg:-mt-1">
                ...
                <p className="font-montserrat font-medium text-customCream text-xs py-1 md:text-sm lg:py-2 lg:text-md text-center">
